...
<p>
	...
	<xsl:value-of select="@leader-id"/><br/>
	</xsl:for-each>
	<b>Accepted: </b><xsl:value-of select="@accepted"/>
</p>
</xsl:template>
...
<p>
	...
	<b>Startdate: </b><xsl:value-of select="@startdate"/><br/>
	<b>Enddate: </b><xsl:value-of select="@enddate"/><br/>
	<b>used resources: </b>
	<xsl:for-each select="uses">
	<br/><xsl:value-of select="@resource-id"/>
	</xsl:for-each>
	<br/><b>invited leaders: </b>
	<xsl:for-each select="invited">
	<br/><xsl:value-of select="@invitation-id"/>
	</xsl:for-each>
</p>
</xsl:template>
...
<p>
	<b>ID: </b><xsl:value-of select="@id"/><br/>
	<b>Info: </b><xsl:value-of select="@info"/><br/>
	<b>Duedate: </b><xsl:value-of select="@duedate"/><br/>
	<b>assigned to: </b>
	<xsl:for-each select="assigned">
	<br/><xsl:value-of select="@leader-id"/>
	</xsl:for-each>
</p>
</xsl:template>
